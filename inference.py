...
if __name__ == "__main__":
    ...
    while True:
        ...
        with torch.no_grad():
            ...
            if pred_label == 2:
                print("\tResult: "+ colored(map_dict[pred_label], "blue") + ", Accuracy: " + colored(output[0][pred_label].item(), "blue") + "\n")
            elif pred_label == 1:
                print("\tResult: "+ colored(map_dict[pred_label], "yellow") + ", Accuracy: " + colored(output[0][pred_label].item(), "yellow") + "\n")
            else:
                print("\tResult: "+ colored(map_dict[pred_label], "red") + ", Accuracy: " + colored(output[0][pred_label].item(), "red") + "\n")
